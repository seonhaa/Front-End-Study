...
// circular reference: 서로가 참조하는 레퍼런스
// constructor 키는 IdolModel과 같은 메모리 주소를 참조.
...
// proto 변경 전: FemaleIdolModel
console.log(ray.constructor);

console.log("------------------------------");

// prototype 변경 (상속 변경): IdolModel
